import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./iframe-Db2NJZa7.js";import{n,t as r}from"./PageHeader-BBo5L0EB.js";function i(e,t){return Array.from({length:e},(e,n)=>{let r=n+1>=t&&t>0?`link`:`label`;return{label:c[n]??`Level ${n+1}`,type:r,href:r===`link`?`#`:void 0}})}function a(e){let{levelCount:t,linksStartAt:n,...a}=e;return(0,o.jsx)(r,{...a,levels:i(t,n)})}var o,s,c,l,u,d,f,p,m,h,g;e((()=>{n(),o=t(),s=8,c=[`Home`,`Products`,`Electronics`,`Computers`,`Laptops`,`Gaming`,`Budget`,`Refurbished`],l={title:`Content Panel/Page Header`,component:r,parameters:{layout:`padded`},argTypes:{title:{control:`text`,description:`Page title text`},levelCount:{control:{type:`range`,min:0,max:s,step:1},description:`Number of breadcrumb levels (0 = title only)`,table:{category:`Breadcrumb`}},linksStartAt:{control:{type:`range`,min:1,max:s,step:1},description:`Links start at this level (levels before it are labels, 1 = all links)`,table:{category:`Breadcrumb`}},showSideNavTrigger:{control:`boolean`,description:`Show/hide the sidebar toggle icon`},sidenavTriggerIcon:{control:`radio`,options:[`menu`,`panel-left-open`,`panel-left-close`],description:`Icon for the sidebar toggle button`},showBreadcrumb:{control:`boolean`,description:`Show/hide the breadcrumb hierarchy`},showStatusBadge:{control:`boolean`,description:`Show/hide the status badge`},statusBadgeLabel:{control:`text`,description:`Status badge label`},showAiTrigger:{control:`boolean`,description:`Show/hide the AI button`},levels:{control:!1,table:{disable:!0}},_sidebarOpen:{control:!1,table:{disable:!0}},headerMiddleSlot:{control:!1,table:{disable:!0}},headerActionsSlot:{control:!1,table:{disable:!0}},breadcrumbSlot:{control:!1,table:{disable:!0}}},args:{title:`Page Title`,levelCount:1,linksStartAt:1,showSideNavTrigger:!0,sidenavTriggerIcon:`panel-left-close`,showBreadcrumb:!0,showStatusBadge:!1,statusBadgeLabel:`Active`,showAiTrigger:!0}},u={name:`Default`,render:e=>(0,o.jsx)(a,{...e})},d={name:`With Status Badge`,render:e=>(0,o.jsx)(a,{...e}),args:{showStatusBadge:!0}},f={name:`No Side Nav Trigger`,render:e=>(0,o.jsx)(a,{...e}),args:{showSideNavTrigger:!1,showBreadcrumb:!1}},p={name:`No AI Trigger`,render:e=>(0,o.jsx)(a,{...e}),args:{showAiTrigger:!1}},m={name:`Many Levels (≥ 4)`,render:e=>(0,o.jsx)(a,{...e}),args:{levelCount:5,linksStartAt:1,title:`Product Detail`}},h={name:`Full Featured`,render:e=>(0,o.jsx)(a,{...e}),args:{showStatusBadge:!0,showSideNavTrigger:!0,showBreadcrumb:!0,showAiTrigger:!0,title:`Case Management`,levelCount:1,linksStartAt:1,statusBadgeLabel:`Active`}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  name: "Default",
