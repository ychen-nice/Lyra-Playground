      ...
      tokens
        ...
        borderBottom: '1px solid rgba(0,0,0,0.05)'
          ...
          gap: 6
            ...
            textOverflow: 'ellipsis',
            whiteSpace: 'nowrap'
          }} title={lightRef ? light : undefined}>{lightRef || light}</span>
              </div>
          ...
          gap: 6
            ...
            textOverflow: 'ellipsis',
            whiteSpace: 'nowrap'
          }} title={darkRef ? dark : undefined}>{darkRef || dark}</span>
              </div>
              {/* Description */}
              <span style={{
          fontSize: '0.6875rem',
